...
function fn_ult_get_products_search_conditions_pre(
    &$params,
    &$items_per_page,
    &$lang_code,
    ...
    if (Registry::get('runtime.company_id') && !Registry::get('runtime.simple_ultimate')) {
        // In a multistorefront-mode product searching must use the shared descriptions table,
        // which will be joined at fn_ult_get_products().
        $search_text_fields_table_alias = 'shared_descr';
    }
}
