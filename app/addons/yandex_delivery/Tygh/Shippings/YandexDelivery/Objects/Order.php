...
class Order extends YandexObject
{
    ...
    public $_fields = array("num", "date", "weight", "width", "height", "length", "payment_method", "delivery_cost", "assessed_value", "comment", "items", "sender", "requisite", "warehouse", "user_status_id", "total_cost", 'amount_prepaid');
