...
function fn_yml_export_is_need_watermark_post($object_type, $is_detailed, $company_id, &$result)
{
    static $is_yml_generate = null;

    if ($is_yml_generate == null) {
        if (Registry::get('runtime.controller') == 'yml' && Registry::get('runtime.mode') == 'generate') {
            $is_yml_generate = true;
        } else {
            $is_yml_generate = false;
        }
    }
