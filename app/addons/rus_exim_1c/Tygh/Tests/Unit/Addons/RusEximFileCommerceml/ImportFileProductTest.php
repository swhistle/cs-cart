...
class ImportFileProductTest extends ATestCase
{
    ...
    protected function setUp()
    {
        ...
        RusEximCommerceml::$cml = $this->cml;
        RusEximCommerceml::$s_commerceml = $this->s_commerceml;
        RusEximCommerceml::$path_commerceml = $this->path_files_for_tests;
        RusEximCommerceml::$company_id = 0;
    }
    ...
    public function getSettingsExim()
    {
        $exim_settings = array(
            ...
            'exim_1c_category_link_type' => 'main',
    ...
    public function testGetFileCommerceml($data_xml, $file)
    {
        ...
        list($xml, $status, $text_message) = RusEximCommerceml::getFileCommerceml($file);
    ...
    public function testGetCompanyIdByLinkType($link_type, $group, $expected_sql, $expected_sql_param)
    {
        ...
        RusEximCommerceml::getCompanyIdByLinkType($link_type, $_group);
    }
    ...
    public function testGetDataCategoryByFile($group, $category_id, $parent_id, $lang_code, $data_comparison)
    {
        ...
        $data_file = RusEximCommerceml::getDataCategoryByFile($_group, $category_id, $parent_id, $lang_code);
    ...
    public function testDataFeatures($feature_name, $feature_id, $feature_type, $data_type, $used_brand, $property_for_manufacturer, $external_id, $data_comparison)
    {
        ...
        $data_features = RusEximCommerceml::dataFeatures($feature_name, $feature_id, $data_type, $used_brand, $property_for_manufacturer, $external_id);
    ...
    public function testGetProductDataByLinkType($link_type, $product, $expected_sql, $expected_sql_param)
    {
        ...
        RusEximCommerceml::getProductDataByLinkType($link_type, $_product, $this->cml);
    }
    ...
    {
        list($external_id, $combination_id) = RusEximCommerceml::getProductIdByFile($ids);
    ...
    public function testGetAdditionalDataProduct($requisites, $t_full_name, $t_product_code, $t_html_description)
    {
        ...
        list($full_name, $product_code, $html_description) = RusEximCommerceml::getAdditionalDataProduct($_requisites, $this->cml);
    ...
    public function testGetProductNameByType($type_name, $product, $full_name, $name_comparison)
    {
        ...
        $product_name = RusEximCommerceml::getProductNameByType($type_name, $_product, $full_name, $this->cml);
    ...
    public function testGetProductCodeByTypeCode($type_code, $product, $product_code, $code_comparison)
    {
        ...
        $product_code = RusEximCommerceml::getProductCodeByTypeCode($type_code, $_product, $product_code, $this->cml);
    ...
    public function testGetProductDescriptionByType($type_description, $product, $html_description, $full_name, $t_description)
    {
        ...
        $description = RusEximCommerceml::getProductDescriptionByType($type_description, $_product, $html_description, $full_name, $this->cml);
    ...
    public function testGetProductPageTitle($type_description, $product, $full_name, $t_page_title)
    {
        ...
        $page_title = RusEximCommerceml::getProductPageTitle($type_description, $_product, $full_name, $this->cml);
    ...
    public function testAddProductTaxes($data_tax, $product_id, $company_id, $_expected_sql, $expected_sql_params)
    {
        ...
        RusEximCommerceml::addProductTaxes($_data_tax, $product_id);
    }
    ...
    {
        $order_xml = RusEximCommerceml::getOrderDataForXml($order_data, $this->cml);
    ...
    {
        list($payment, $shipping) = RusEximCommerceml::getAdditionalOrderData($order_data);
    ...
    {
        $user_xml = RusEximCommerceml::getDataOrderUser($order_data);
...
<КоммерческаяИнформация xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.v8.1c.ru/edi/edi_stnd/90/CML208.XSD" ВерсияСхемы="2.08" ДатаФормирования="2016-03-02T12:21:30+03:00">
    <Классификатор>
        <Ид>1</Ид>
