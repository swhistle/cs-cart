...
<div id="yandex_market_addon" class="in collapse">
    ...
    <div class="control-group cm-no-hide-input">
        ...
        <div class="controls">
            <select name="product_data[yml_manufacturer_warranty]" id="product_description_manufacturer_warranty">
                <option value=""  {if $product_data.yml_manufacturer_warranty == ""}selected="selected"{/if}>{__("yml_none")}</option>
                <option value="Y" {if $product_data.yml_manufacturer_warranty == "Y"}selected="selected"{/if}>{__("yml_true")}</option>
                <option value="N" {if $product_data.yml_manufacturer_warranty == "N"}selected="selected"{/if}>{__("yml_false")}</option>
            </select>
            {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}
        </div>
    </div>
