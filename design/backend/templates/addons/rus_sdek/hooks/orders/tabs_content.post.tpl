                            ...
                            {if $shipment.register_id}
                                <div class="pull-right">
                                    {capture name="tools_list"}
                                        <li><a class="cm-submit" data-ca-target-form="sdek_form_{$shipment_id}" data-ca-dispatch="dispatch[orders.sdek_order_status]">{__("sdek.update_status")}</a></li>
                                        <li><a class="cm-submit" data-ca-target-form="sdek_form_{$shipment_id}" data-ca-dispatch="dispatch[orders.sdek_call_recipient]">{__("sdek.new_schedule")}</a></li>
                                        <li><a class="cm-submit" data-ca-target-form="sdek_form_{$shipment_id}" data-ca-dispatch="dispatch[orders.sdek_call_courier]">{__("sdek.call_courier")}</a></li>
                                        <li><a class="cm-submit" data-ca-target-form="sdek_form_{$shipment_id}" data-ca-dispatch="dispatch[orders.sdek_order_delete]">{__("delete")}</a></li>
                                    {/capture}
