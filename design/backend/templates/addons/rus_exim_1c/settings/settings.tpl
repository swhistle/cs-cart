...
<div class="control-group setting-wide disable-overlay-wrap" id="select_default_category">
    ...
    <div class="control-group">
        ...
        <label class="control-label" for="addon_option_rus_exim_1c_exim_1c_select_default_category">{__('addons.rus_exim_1c.exim_1c_select_default_category')} {include file="common/tooltip.tpl" tooltip=__("addons.rus_exim_1c.exim_1c_select_default_category_tooltip")}:</label>
